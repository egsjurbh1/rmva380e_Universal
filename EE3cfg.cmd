...
_KNL_swi = KNL_swi;
_TSK_idle = TSK_idle;
_tskNetWorkMain = tskNetWorkMain;
_tskJPGEncoder = tskJPGEncoder;
_tskAcmdBDmain = tskAcmdBDmain;
_IDL_cpuLoad = IDL_cpuLoad;
_LNK_dataPump = LNK_dataPump;
_RTA_dispatcher = RTA_dispatcher;
_LOG_system = LOG_system;
_trace = trace;
_sem_ConDataReady = sem_ConDataReady;
_sem_TrgDataReady = sem_TrgDataReady;
_sem_HfconDataReady = sem_HfconDataReady;
_sem_HfrBinconDataRdy = sem_HfrBinconDataRdy;
_sem_CalSpeed = sem_CalSpeed;
_sem_LiveStreamDataReady = sem_LiveStreamDataReady;
_sem_JpegReady = sem_JpegReady;
_sem_LiveStreamDataReady_Another = sem_LiveStreamDataReady_Another;
_sem_AcmdBDReady = sem_AcmdBDReady;
_sem_FcontoDecReady = sem_FcontoDecReady;
_sem_DpDataReady1 = sem_DpDataReady1;
_sem_DpDataReady2 = sem_DpDataReady2;
_sem_SendVideoReady = sem_SendVideoReady;
_sem_DecClientReady = sem_DecClientReady;
...
MEMORY {
   ...
   DDR2        : origin = 0xe0000000,  len = 0x20000000
   IRAM        : origin = 0xa00000,    len = 0x80000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
